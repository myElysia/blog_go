...
func newCategory(db *gorm.DB, opts ...gen.DOOption) category {
	...
	_category.TopCategoryID = field.NewUint(tableName, "top_category_id")
...
func (c *category) updateTableName(table string) *category {
	...
	c.TopCategoryID = field.NewUint(table, "top_category_id")
...
func (c *category) fillFieldMap() {
	...
	c.fieldMap["top_category_id"] = c.TopCategoryID
