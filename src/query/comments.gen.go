...
func newComment(db *gorm.DB, opts ...gen.DOOption) comment {
	...
	_comment.CreatedBy = field.NewUint(tableName, "created_by")
	_comment.UpdatedBy = field.NewUint(tableName, "updated_by")
	_comment.DeletedBy = field.NewUint(tableName, "deleted_by")
	_comment.ArticleID = field.NewUint(tableName, "article_id")
	_comment.IsTop = field.NewBool(tableName, "is_top")
	_comment.Comment = field.NewString(tableName, "comment")
	_comment.TopCommentID = field.NewUint(tableName, "top_comment_id")
...
func (c *comment) updateTableName(table string) *comment {
	...
	c.CreatedBy = field.NewUint(table, "created_by")
	c.UpdatedBy = field.NewUint(table, "updated_by")
	c.DeletedBy = field.NewUint(table, "deleted_by")
	c.ArticleID = field.NewUint(table, "article_id")
	c.IsTop = field.NewBool(table, "is_top")
	c.Comment = field.NewString(table, "comment")
	c.TopCommentID = field.NewUint(table, "top_comment_id")
...
func (c *comment) fillFieldMap() {
	...
	c.fieldMap["top_comment_id"] = c.TopCommentID
}
